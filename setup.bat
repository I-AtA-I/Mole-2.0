...
python -m pip install colorama pywin32 pycryptodome pynput opencv-python numpy sounddevice soundfile psutil mss pillow readline --quiet --disable-pip-version-check
